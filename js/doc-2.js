...
switch (seleccionEnvio) {
    case 1:
        alert("Usted selecciono Envio a domicilio")
        precioConEnvio = precioProducto + precioEnvio;
        alert("El costo del producto + el envio es: $"+precioConEnvio)
    break;
    case 2:
...
// mediante switch ofrecemos el catalogo de producto
    ...
    case 1:
        ...
        algoMas()
    break;
    case 2:alert("Usted selecciono una Campera Lion");
        precioProducto = precioCampera
        envio()
        algoMas()
    break;
    case 3:alert("Usted selecciono un Saco Megan");
        precioProducto = precioSaco
        envio()
        algoMas()
    break;
    case 4:alert("Usted selecciono una Remera Basic");
